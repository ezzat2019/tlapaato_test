...
public class MapsActivity extends FragmentActivity   implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Helper.setLocal(getBaseContext(),"ar");
        ...
        Places.initialize(getApplicationContext(), "AIzaSyD8P6R7sbfHcf01J4fHh7O9ABc2dUb1uaA");
...
//    }
    ...
    public void onLocationChanged(Location location)
    {
        ...
        Log.d("vvvvvvv", "onLocationChanged: ");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == AUTOCOMPLETE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                Log.d("vvvvvvvv", "Place: " + place.getName() + ", " + place.getId());
            } else if (resultCode == AutocompleteActivity.RESULT_ERROR) {
                // TODO: Handle the error.
                Status status = Autocomplete.getStatusFromIntent(data);
                Log.d("vvvvvvvvvv", status.getStatusMessage());
